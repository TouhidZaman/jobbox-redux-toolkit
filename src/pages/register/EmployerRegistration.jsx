...
const EmployerRegistration = () => {
  ...
  const [postUser, { isSuccess, isLoading, isError, error }] =
  ...
  //handling post success or error case
  useEffect(() => {
  ...
  }, [navigate, isLoading, isSuccess, dispatch, isError, error]);

  const onSubmit = (data) => {
    dispatch(postUser({ ...data, email, role: "employer" }));
  };
